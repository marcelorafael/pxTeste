...
async function go() {
  ...
  const ignoredPatterns = (parsedArgs.ignore || builtInIgnore).split(',').map(pattern => path.join(pathToOutDir, pattern)); // type def files are compiled to an empty file and they're useless
